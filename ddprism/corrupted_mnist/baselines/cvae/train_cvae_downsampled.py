...
def main(_):
    ...
    corrupt_obs, A_mat, cov_y, labels = datasets.get_dataset(
        ...
        config_mnist.downsampling_ratios, config_mnist.sample_batch_size, imagenet_path,
    ...
    f_train_uncorrupted = get_full_resolution_examples_only(config_mnist, uncorrupt_obs, labels)
    ...
    corrupt_obs, A_mat, cov_y, labels = datasets.get_dataset(
        ...
        config_grass.downsampling_ratios, config_grass.sample_batch_size, imagenet_path,
        config_grass.dataset_size, zeros_and_ones=True,
    )
    b_train = get_full_resolution_examples_only(config_mnist, corrupt_obs, labels)
