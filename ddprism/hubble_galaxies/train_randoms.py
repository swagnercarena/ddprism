...
from hg_utils import create_posterior_train_state_randoms
...
def main(_):
    ...
    post_state_gauss = create_posterior_train_state_randoms(
    ...
    post_state_unet = create_posterior_train_state_randoms(
